 ...
 */
class AjaxProductsList extends \Magento\Catalog\Block\Product\AbstractProduct implements \Magento\Widget\Block\BlockInterface
{
    /**
    ...
    {
	  if(!$idJs = $this->getData('unique_id'))
			$this->setData('unique_id','ajaxfilterproducts-'.rand(0,100));
    	  $this->setWidgetData($this->getData());     	  
    ...
    public function getPagerHtml()
    {
        if ($this->showPager() && $this->getProductCollection()->getSize() > $this->getProductsPerPage()) {
            ...
            $this->_maxPage = $this->pager->getLastPageNum();       
        }
        return '';
    }
