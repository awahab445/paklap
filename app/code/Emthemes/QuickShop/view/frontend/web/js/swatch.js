    ...
    $.widget('custom.SwatchRenderer', {
        ...
        _create: function () {
            var options = this.options,
                gallery = $('[data-gallery-role=gallery-placeholder]', '.qs-content'),
                isProductViewExist = $('body.em-quickview').size() > 0,
                $main = isProductViewExist ?
                    this.element.parents('.qs-content') :
        ...
        _EnableProductMediaLoader: function ($this) {
            ...
            if ($('body.em-quickview').size() > 0) {
                $this.parents('.qs-content').find('.photo.image')
        ...
        _ProductMediaCallback: function ($this, response) {
            var isProductViewExist = $('body.em-quickview').size() > 0,
                $main = isProductViewExist
                    ? $this.parents('.qs-content')
