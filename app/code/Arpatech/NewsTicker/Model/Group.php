...
class Group extends \Magento\Framework\Model\AbstractModel implements NewsInterface, IdentityInterface
{
    /**
     * No route page id
     */
     ...
     */
    const CACHE_TAG = 'wk_newsticker_group';

    /**
     * @var string
     */
    protected $_cacheTag = 'wk_newsticker_group';
     ...
     * @var string
     */
    protected $_eventPrefix = 'wk_newsticker_group';
    ...
    {
        $this->_init('Arpatech\NewsTicker\Model\ResourceModel\Group');
    }
